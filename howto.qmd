...
If you would prefer to read offline, you can [download the guide as a PDF](https://github.com/royal-statistical-society/datavisguide/blob/full-pdf/RSS-data-vis-guide.pdf). Individual sections of the guide can also be downloaded as separate PDFs using the "Other Formats \> PDF" option when shown in the right-hand navigation menu.
