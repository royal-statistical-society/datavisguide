...
![Screenshot of From Data to Viz](images/choosing-data-to-viz.png){fig-alt="Screenshot of From Data to Viz website, showing decision tree of chart formats suitable for numeric data"}
...
![Screenshot of Visual Vocabulary](images/choosing-visual-vocabulary.png){fig-alt="Screenshot of the Visual Vocabulary website, showing chart types suitable for visualising deviations from fixed reference points"}
